...
extension EvaluationLocalization on AppLocalizations {
  ...
  String get evaluationActivity =>
      _evaluationEnglish ? 'Activity' : 'Actividad';
  ...
  String get evaluationAchievement =>
      _evaluationEnglish ? 'Achievement' : 'Logro';
  ...
  String get evaluationDelivered =>
      _evaluationEnglish ? 'Delivered' : 'Entregó';
  ...
  String get achievementMastered =>
      _evaluationEnglish ? 'Mastered' : 'Dominado';
  ...
  String get evaluationSave =>
      _evaluationEnglish ? 'Save evaluation' : 'Guardar evaluación';
  ...
  String get evaluationEvaluated =>
      _evaluationEnglish ? 'Evaluated' : 'Evaluados';
  ...
  String get evaluationPendingMetric =>
      _evaluationEnglish ? 'Pending' : 'Pendientes';
