...
void main() {
  test('encrypted backup can be inspected and staged with installation key', () async {
    ...
    expect(staged.preview.manifest.createdAtUtc, DateTime.utc(2026, 8, 23, 12, 30));
  });
}

Future<Uint8List> _createDatabaseBytes(Directory directory) async {
  final file = File('${directory.path}${Platform.pathSeparator}candidate.sqlite');
